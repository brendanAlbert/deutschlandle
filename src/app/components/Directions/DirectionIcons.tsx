const getDirectionIcon = (number: number, height?: string) => {
  switch (number) {
    case 3:
    case 4:
...
const upRightArrow = (height?: string) => (
  <img
    alt="↗"
    height={height ?? "14px"}
...
const rightArrow = (height?: string) => (
  <img
    alt="➡"
    height={height ?? "14px"}
...
const downRightArrow = (height?: string) => (
  <img
    alt="↘"
    height={height ?? "14px"}
...
const downLeftArrow = (height?: string) => (
  <img
    alt="↙"
    height={height ?? "14px"}
...
const upLeftArrow = (height?: string) => (
  <img
    alt="↖"
    height={height ?? "14px"}
